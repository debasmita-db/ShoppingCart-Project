...
<div id="outerWrapper">
    ...
    <div id="header" class="clearfix">
    	<div class="pagelogo">
            ...
            <h1 class="hidden"> Web Designer && Developer - Demo</h1>
        </div>
        <div class="promotion">
    ...
    <div id="contentWrapper">        
        ...
        <!-- ================================================== -->
        <div id="slider1_container" style="display: none; position: relative; margin: 10px auto; width: 960px;
        height: 360px; overflow: hidden;">
            ...
            <!-- Slides Container -->
            <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 960px; height: 360px;
            overflow: hidden;">
                <div>
                    <img u="image" src2="images/slide/slide1.jpg" />
                </div>
                <div>
                    <img u="image" src2="images/slide/slide3.jpg" />
                </div>
                <div>
                    <img u="image" src2="images/slide/slide4.jpg" />
                </div>
            </div>
